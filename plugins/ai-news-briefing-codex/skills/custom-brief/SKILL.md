...
Launch **at least 5 parallel research agents** using the Agent tool. You MUST include the 5 core angles below. You MAY add 1-3 more agents if the topic has dimensions not well covered by the core set.
...
Publish the results to the requested destinations (Notion, Obsidian, Teams, Slack) using the logic provided in the prompt.